module github.com/brotherlogic/crasher
...
require (
	...
	github.com/brotherlogic/keystore v0.0.0-20220919100110-299b209de552 // indirect
	...
	github.com/brotherlogic/monitor v0.0.0-20200610021023-f01db8d3fdc3 // indirect
